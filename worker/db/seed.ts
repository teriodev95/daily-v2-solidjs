  ...
  const recurringStories = [
    {
      ...
      description: 'Atención diaria a tickets de soporte',
    ...
    },
    {
      ...
      description: 'Revisión semanal de débitos',
      priority: 'medium', estimate: 0, status: 'todo', category: null,
    ...
    },
    {
      ...
      description: 'Revisión mensual de servidores',
      priority: 'medium', estimate: 0, status: 'todo', category: null,
      assignee_id: 'u2', created_by: 'u2',
      due_date: null, scheduled_date: null, completed_at: null,
      is_shared: false, sort_order: 0,
...
seed.post('/seed', async (c) => {
  ...
  const storyRows = [
    // ─ Jesús (u1) ─
    { id: 's1', project_id: 'p1', code: 'XP-1', title: 'Corrección de edición de campos agencia y gerencia en préstamos V2', description: '## Para qué\nEvitar sobrescritura no deseada de agencia/gerencia al editar préstamos.\n\nAl editar un préstamo en préstamos_v2, los campos agente y gerencia se sobrescriben incorrectamente.\n\nReferencia del bug: https://github.com/equipo-dev/xpress/issues/247\nDocumentación de roles: https://docs.google.com/document/d/1a2b3c4d5e6f/edit\n\n## Objetivo\nSolo "Jefa de Administración" puede modificar estos campos.', priority: 'high', estimate: 4, status: 'in_progress', category: null, assignee_id: 'u1', created_by: 'u1', due_date: '2026-02-25', created_at: '2026-02-15T00:00:00Z', updated_at: '2026-02-20T00:00:00Z' },
    { id: 's2', project_id: 'p1', code: 'XP-2', title: 'Filtro de búsqueda por fecha en reporte de cobranza', description: '## Para qué\nEl equipo de cobranza necesita consultar por rango de fechas.\n\nAgregar filtros de fecha inicio y fecha fin en la vista de reportes.\n\nDiseño en Figma: https://www.figma.com/file/abc123/cobranza-filters\nAPI spec: https://api.xpress.dev/docs#cobranza-reports\n\n## Objetivo\nFiltrar reportes de cobranza por rango de fechas.', priority: 'medium', estimate: 3, status: 'in_progress', category: null, assignee_id: 'u1', created_by: 'u1', due_date: '2026-02-28', created_at: '2026-02-10T00:00:00Z', updated_at: '2026-02-20T00:00:00Z' },
    { id: 's3', project_id: 'p1', code: 'XP-3', title: 'Exportar reporte de préstamos a Excel', description: '## Para qué\nGenerar reportes descargables para auditoría.\n\nBotón de exportación en la vista de préstamos que genera .xlsx con datos filtrados.\n\nUsamos SheetJS: https://docs.sheetjs.com/docs/getting-started/installation\nPR completado: https://github.com/equipo-dev/xpress/pull/189\n\n## Objetivo\nDescargar reporte en formato Excel.', priority: 'low', estimate: 3, status: 'done', category: null, assignee_id: 'u1', created_by: 'u1', due_date: '2026-02-10', completed_at: '2026-02-20T10:30:00Z', created_at: '2026-01-20T00:00:00Z', updated_at: '2026-02-20T10:30:00Z' },
    { id: 's4', project_id: 'p2', code: 'DC-1', title: 'Menú contextual con acciones rápidas', description: '## Para qué\nMejorar la UX del organizador de tareas.\n\nClic derecho sobre una HU para abrir, mover de status o eliminar.\n\nInspiración UX: https://linear.app/docs/issues\nAnimaciones CSS: https://developer.mozilla.org/en-US/docs/Web/CSS/animation\n\n## Objetivo\nAcciones rápidas sin abrir modal.', priority: 'medium', estimate: 2, status: 'done', category: null, assignee_id: 'u1', created_by: 'u1', due_date: null, completed_at: '2026-02-20T14:00:00Z', created_at: '2026-02-19T00:00:00Z', updated_at: '2026-02-20T14:00:00Z' },
    { id: 's5', project_id: null, code: null, title: 'Code review de PRs pendientes', description: 'Revisar los PRs abiertos del equipo.\n\nhttps://github.com/equipo-dev/xpress/pulls\nhttps://github.com/equipo-dev/portal-clientes/pulls', priority: 'medium', estimate: 0, status: 'todo', category: null, assignee_id: 'u1', created_by: 'u1', due_date: null, created_at: '2026-02-20T08:00:00Z', updated_at: '2026-02-20T08:00:00Z' },
    { id: 's6', project_id: 'p1', code: null, title: 'Revisar endpoint de integridad de pagos', description: 'El endpoint /api/payments/integrity devuelve 500 en algunos casos.\n\nLogs: https://dash.cloudflare.com/workers/xpress-api/logs\nSentry: https://sentry.io/organizations/equipo-dev/issues/45678/\n\n## Objetivo\nIdentificar y corregir el error.', priority: 'high', estimate: 0, status: 'backlog', category: null, assignee_id: 'u1', created_by: 'u1', due_date: null, created_at: '2026-02-19T08:00:00Z', updated_at: '2026-02-19T08:00:00Z' },

    // ─ Luis (u2) ─
    { id: 's7', project_id: null, code: null, title: 'Revisar status de servidores en Hetzner', description: '## Para qué\nMonitoreo semanal de infraestructura.\n\nVerificar CPU, RAM y disco en los 3 servidores de producción.\n\nPanel Hetzner: https://console.hetzner.cloud/projects/123456\nRunbook: https://notion.so/equipo-dev/hetzner-runbook-abc123\n\n## Objetivo\nServidores estables y sin alertas.', priority: 'medium', estimate: 1, status: 'in_progress', category: null, assignee_id: 'u2', created_by: 'u1', due_date: '2026-02-21', frequency: 'weekly', day_of_week: 1, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-02-20T09:00:00Z' },
    { id: 's8', project_id: 'p1', code: 'XP-4', title: 'Configurar alertas de Uptime Kuma', description: '## Para qué\nDetectar caídas de servicio automáticamente.\n\nConfigurar monitoreo para los endpoints críticos de Xpress.\n\nUptime Kuma: https://github.com/louislam/uptime-kuma\nEndpoints a monitorear: https://docs.google.com/spreadsheets/d/1xyz/edit\n\n## Objetivo\nAlertas activas en Slack y email.', priority: 'high', estimate: 3, status: 'todo', category: null, assignee_id: 'u2', created_by: 'u1', due_date: '2026-02-26', created_at: '2026-02-18T00:00:00Z', updated_at: '2026-02-18T00:00:00Z' },
    { id: 's9', project_id: null, code: null, title: 'Actualizar certificados SSL de producción', description: 'Los certificados expiran el 1 de marzo.\n\nGuía renovación: https://letsencrypt.org/docs/renewal/\n\n## Objetivo\nCertificados renovados sin downtime.', priority: 'critical', estimate: 1, status: 'done', category: null, assignee_id: 'u2', created_by: 'u2', due_date: '2026-02-19', completed_at: '2026-02-20T11:00:00Z', created_at: '2026-02-17T00:00:00Z', updated_at: '2026-02-20T11:00:00Z' },

    // ─ Diego (u3) ─
    { id: 's10', project_id: null, code: null, title: 'Revisar TFD tickets del día', description: '## Para qué\nAtención diaria a soporte técnico.\n\nRevisar y responder tickets asignados en el sistema TFD.\n\nhttps://tfd.equipo-dev.com/tickets?assignee=diego\n\n## Objetivo\nTodos los tickets respondidos antes de las 5pm.', priority: 'medium', estimate: 0, status: 'in_progress', category: null, assignee_id: 'u3', created_by: 'u3', due_date: null, frequency: 'daily', created_at: '2026-01-01T00:00:00Z', updated_at: '2026-02-20T08:00:00Z' },
    { id: 's11', project_id: 'p1', code: 'XP-5', title: 'Actualizar catálogo de gerencias en BD', description: '## Para qué\nSincronizar catálogo con las nuevas gerencias del organigrama.\n\nAgregar 5 nuevas gerencias al catálogo.\n\nScript de migración: https://github.com/equipo-dev/xpress/blob/main/migrations/add-gerencias.sql\nOrganigrama actualizado: https://drive.google.com/file/d/1abc/view\n\n## Objetivo\nCatálogo actualizado y validado.', priority: 'medium', estimate: 2, status: 'done', category: null, assignee_id: 'u3', created_by: 'u1', due_date: '2026-02-19', completed_at: '2026-02-19T16:00:00Z', created_at: '2026-02-15T00:00:00Z', updated_at: '2026-02-19T16:00:00Z' },
    { id: 's12', project_id: 'p1', code: null, title: 'Documentar proceso de alta de gerencias', description: 'Crear guía paso a paso para agregar gerencias nuevas.\n\nPlantilla: https://notion.so/equipo-dev/template-procesos', priority: 'low', estimate: 1, status: 'todo', category: null, assignee_id: 'u3', created_by: 'u3', due_date: null, created_at: '2026-02-20T08:00:00Z', updated_at: '2026-02-20T08:00:00Z' },

    // ─ Alejandro (u4) ─
    { id: 's13', project_id: 'p3', code: 'PC-1', title: 'Dashboard de estado de cuenta del cliente', description: '## Para qué\nDar visibilidad al cliente sobre pagos y saldos.\n\nVista principal del portal con resumen de pagos, próximo pago y saldo.\n\nWireframes: https://www.figma.com/file/xyz789/portal-clientes-v1\nAPI de pagos: https://api.xpress.dev/docs#client-balance\n\n## Objetivo\nEl cliente ve su estado de cuenta actualizado.', priority: 'high', estimate: 8, status: 'in_progress', category: null, assignee_id: 'u4', created_by: 'u1', due_date: '2026-03-15', created_at: '2026-02-05T00:00:00Z', updated_at: '2026-02-20T00:00:00Z' },
    { id: 's14', project_id: 'p3', code: 'PC-2', title: 'Autenticación del portal con token JWT', description: '## Para qué\nAcceso seguro para clientes.\n\nImplementar login con JWT para el portal.\n\nReferencia: https://jwt.io/introduction\nLibrería: https://github.com/panva/jose\n\n## Objetivo\nLogin funcional con refresh token.', priority: 'critical', estimate: 5, status: 'todo', category: null, assignee_id: 'u4', created_by: 'u1', due_date: '2026-03-01', created_at: '2026-02-10T00:00:00Z', updated_at: '2026-02-10T00:00:00Z' },
    { id: 's15', project_id: null, code: null, title: 'Preparar demo de cobranza para cliente', description: 'Demo del módulo de cobranza para el viernes.\n\nSlides: https://docs.google.com/presentation/d/1demo-pres/edit\n\n## Objetivo\nDemo lista y ensayada.', priority: 'high', estimate: 0, status: 'done', category: null, assignee_id: 'u4', created_by: 'u1', due_date: '2026-02-21', completed_at: '2026-02-20T13:00:00Z', created_at: '2026-02-17T00:00:00Z', updated_at: '2026-02-20T13:00:00Z' },

    // ─ Adrián Martínez (u5) ─
    { id: 's16', project_id: 'p1', code: 'XP-6', title: 'Optimizar queries de reporte mensual', description: '## Para qué\nEl reporte mensual tarda más de 30 segundos.\n\nAgregar índices y optimizar las queries del reporte.\n\nPlan de ejecución actual: https://explain.depesz.com/s/abc123\nGuía de optimización: https://use-the-index-luke.com/\n\n## Objetivo\nReporte en menos de 3 segundos.', priority: 'high', estimate: 5, status: 'in_progress', category: null, assignee_id: 'u5', created_by: 'u1', due_date: '2026-02-24', created_at: '2026-02-14T00:00:00Z', updated_at: '2026-02-20T00:00:00Z' },
    { id: 's17', project_id: 'p1', code: null, title: 'Investigar migración a Turso para edge DB', description: 'Evaluar viabilidad de migrar la BD SQLite a Turso.\n\nhttps://turso.tech/\nhttps://docs.turso.tech/sdk/ts/quickstart\n\n## Objetivo\nReporte de viabilidad con pros/contras.', priority: 'low', estimate: 2, status: 'backlog', category: null, assignee_id: 'u5', created_by: 'u5', due_date: null, created_at: '2026-02-18T00:00:00Z', updated_at: '2026-02-18T00:00:00Z' },

    // ─ Adrian Orozco (u6) ─
    { id: 's18', project_id: 'p3', code: 'PC-3', title: 'Configurar ambiente de staging del portal', description: '## Para qué\nTener un entorno de pruebas para el portal.\n\nLevantar infra en Cloudflare Pages + Workers para staging.\n\nGuía Pages: https://developers.cloudflare.com/pages/\nWrangler CLI: https://developers.cloudflare.com/workers/wrangler/\n\n## Objetivo\nStaging desplegado y accesible.', priority: 'medium', estimate: 3, status: 'in_progress', category: null, assignee_id: 'u6', created_by: 'u1', due_date: '2026-02-25', created_at: '2026-02-15T00:00:00Z', updated_at: '2026-02-20T00:00:00Z' },
    { id: 's19', project_id: 'p3', code: null, title: 'Diseñar componentes UI del portal', description: 'Crear sistema de diseño base para el portal.\n\nDaisyUI: https://daisyui.com/components/\nTailwind: https://tailwindcss.com/docs\n\n## Objetivo\nComponentes base listos.', priority: 'medium', estimate: 4, status: 'todo', category: null, assignee_id: 'u6', created_by: 'u6', due_date: '2026-03-05', created_at: '2026-02-18T00:00:00Z', updated_at: '2026-02-18T00:00:00Z' },

    // ─ Mane (u7) ─
    { id: 's20', project_id: 'p2', code: 'DC-2', title: 'Búsqueda global de historias de usuario', description: '## Para qué\nEncontrar cualquier HU rápidamente con Cmd+K.\n\nImplementar modal de búsqueda con fuzzy search.\n\nReferencia UX: https://linear.app\nFuse.js para búsqueda: https://www.fusejs.io/\n\n## Objetivo\nBuscar HUs por título, código o proyecto.', priority: 'medium', estimate: 3, status: 'in_progress', category: null, assignee_id: 'u7', created_by: 'u1', due_date: '2026-02-24', created_at: '2026-02-17T00:00:00Z', updated_at: '2026-02-20T00:00:00Z' },
    { id: 's21', project_id: 'p2', code: 'DC-3', title: 'Atajos de teclado para navegación', description: '## Para qué\nPower users necesitan navegar sin mouse.\n\nTeclas: I=Inicio, R=Reporte, E=Equipo, P=Proyectos, N=Nueva HU.\n\nInspiración: https://github.com/jamiebuilds/tinykeys\nAtajos de Linear: https://linear.app/docs/keyboard-shortcuts\n\n## Objetivo\nNavegación completa por teclado.', priority: 'low', estimate: 2, status: 'done', category: null, assignee_id: 'u7', created_by: 'u7', due_date: null, completed_at: '2026-02-20T15:30:00Z', created_at: '2026-02-19T00:00:00Z', updated_at: '2026-02-20T15:30:00Z' },
    { id: 's22', project_id: 'p2', code: null, title: 'Agregar soporte para adjuntos en HUs', description: 'Subir archivos a R2 y vincularlos a historias.\n\nR2 docs: https://developers.cloudflare.com/r2/\nDrag & drop: https://developer.mozilla.org/en-US/docs/Web/API/HTML_Drag_and_Drop_API\n\n## Objetivo\nUpload de archivos funcional.', priority: 'medium', estimate: 4, status: 'todo', category: null, assignee_id: 'u7', created_by: 'u7', due_date: '2026-03-01', created_at: '2026-02-20T00:00:00Z', updated_at: '2026-02-20T00:00:00Z' },
  ];
