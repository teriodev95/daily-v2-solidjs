        ...
        <Show when={data() && !data.loading}>
          ...
          <div class="relative mb-3">
            ...
            <input
              ...
              placeholder="Buscar por periodo, concepto…"
            ...
            <Show when={filtered().length === 0}>
              <div class="px-4 py-10 text-center">
                ...
                <p class="text-sm font-medium text-base-content/50">
                  <Show when={query()} fallback="Aún no hay facturas">Sin resultados</Show>
                </p>
              </div>
            </Show>
            <For each={filtered()}>
                  ...
                  <div class="flex items-start justify-between gap-3">
                    <div class="min-w-0 flex-1">
                      <div class="flex flex-wrap items-center gap-2">
                        ...
                        <span class="text-[11px] font-semibold text-base-content/55">{inv.period}</span>
